...
def main():
    print("hello")
    s = Student("Dylan","McCallum", 100, 98,85)
    print(repr(s))
    ...
    while stop_input == 'no':
        ...
        while count != 0:
            ...
            try:
                ...
                student_fname = str(input("Enter the student's first name: ")).title()
                
                # validates that both name only contains letters
                if not student_fname.isalpha():
                    print("Invalid input, only letters")
                    continue
                
                student_lname = str(input("Enter the student's last name: ")).title()
                
                if not student_lname.isalpha():
                    print("Invalid input, only letters")
                    continue
